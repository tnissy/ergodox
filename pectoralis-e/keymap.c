...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    ...
    KC_TRANSPARENT, KC_LEFT_ALT,    KC_LEFT_GUI,    MT(MOD_LCTL, KC_BSPC),LT(1,KC_SPACE),                                                                                                 LT(2,KC_ENTER), RSFT(KC_RIGHT_CTRL),KC_TRANSPARENT, LGUI(KC_S),     KC_TRANSPARENT,
  ...
  [1] = LAYOUT_ergodox_pretty(
    ...
    ST_MACRO_0,     LCTL(KC_A),     LCTL(KC_S),     KC_LEFT_CTRL,   KC_LEFT_SHIFT,  ST_MACRO_1,                                                                     KC_NO,          KC_LEFT,        KC_DOWN,        KC_UP,          KC_RIGHT,       KC_NO,
    ...
    KC_TRANSPARENT, KC_LEFT_ALT,    KC_LEFT_GUI,    KC_N,           KC_TRANSPARENT,                                                                                                 KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_TRANSPARENT,
                                                                                                    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                                                    KC_TRANSPARENT, KC_TRANSPARENT,
  ...
  [2] = LAYOUT_ergodox_pretty(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    TO(0),          KC_NO,          KC_7,           KC_8,           KC_9,           KC_LANGUAGE_2,  KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_NO,          KC_LCBR,        KC_LBRC,        KC_RBRC,        KC_RCBR,        KC_PIPE,
    KC_TRANSPARENT, KC_SLASH,       KC_4,           KC_5,           KC_6,           KC_TILD,                                                                        DM_PLY1,        KC_PLUS,        KC_LPRN,        KC_RPRN,        KC_UNDS,        KC_COLN,
    KC_TRANSPARENT, KC_COLN,        KC_1,           KC_2,           KC_3,           KC_GRAVE,       KC_TRANSPARENT,                                 KC_TRANSPARENT, DM_PLY2,        KC_EQUAL,       KC_LABK,        KC_RABK,        KC_QUES,        KC_DQUO,
    KC_TRANSPARENT, KC_TRANSPARENT, KC_0,           KC_COMMA,       KC_DOT,                                                                                                         KC_TRANSPARENT, RSFT(KC_RIGHT_CTRL),KC_SPACE,       KC_NO,          KC_TRANSPARENT,
                                                                                                    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                                                    KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                    KC_ENTER,       KC_BSPC,        KC_TRANSPARENT, KC_TRANSPARENT, KC_NO,          ST_MACRO_2
  ),
  [3] = LAYOUT_ergodox_pretty(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          QK_BOOT,
  ...
  [4] = LAYOUT_ergodox_pretty(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    KC_TRANSPARENT, KC_LEFT_CTRL,   KC_LEFT_ALT,    MT(MOD_LGUI, KC_BSPC),LT(5,KC_SPACE),                                                                                                 LT(6,KC_ENTER), RSFT(KC_RIGHT_GUI),KC_TRANSPARENT, RGUI(KC_SPACE), KC_TRANSPARENT,
                                                                                                    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                                                    KC_TRANSPARENT, KC_TRANSPARENT,
  ...
  [5] = LAYOUT_ergodox_pretty(
    ...
    LGUI(KC_BSPC),  LGUI(KC_A),     LGUI(KC_S),     KC_LEFT_GUI,    KC_LEFT_SHIFT,  LCTL(KC_K),                                                                     KC_NO,          KC_LEFT,        KC_DOWN,        KC_UP,          KC_RIGHT,       KC_NO,
    ...
    KC_TRANSPARENT, KC_LEFT_CTRL,   KC_LEFT_ALT,    KC_N,           KC_TRANSPARENT,                                                                                                 KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_TRANSPARENT,
                                                                                                    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                                                    KC_TRANSPARENT, KC_TRANSPARENT,
  ...
  [6] = LAYOUT_ergodox_pretty(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    TO(4),          KC_NO,          KC_7,           KC_8,           KC_9,           KC_LANGUAGE_2,  KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_NO,          KC_LCBR,        KC_LBRC,        KC_RBRC,        KC_RCBR,        KC_PIPE,
    KC_TRANSPARENT, KC_SLASH,       KC_4,           KC_5,           KC_6,           KC_TILD,                                                                        DM_PLY1,        KC_PLUS,        KC_LPRN,        KC_RPRN,        KC_UNDS,        KC_COLN,
    KC_TRANSPARENT, KC_COLN,        KC_1,           KC_2,           KC_3,           KC_GRAVE,       KC_TRANSPARENT,                                 KC_TRANSPARENT, DM_PLY2,        KC_EQUAL,       KC_LABK,        KC_RABK,        KC_QUES,        KC_DQUO,
    KC_TRANSPARENT, KC_LEFT_GUI,    KC_0,           KC_COMMA,       KC_DOT,                                                                                                         KC_TRANSPARENT, RALT(KC_RIGHT_GUI),KC_SPACE,       KC_NO,          KC_TRANSPARENT,
                                                                                                    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                                                    KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                    KC_ENTER,       KC_BSPC,        KC_TRANSPARENT, KC_TRANSPARENT, KC_NO,          KC_NO
  ),
  [7] = LAYOUT_ergodox_pretty(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_TRANSPARENT,                                 KC_TRANSPARENT, DM_RSTP,        KC_NO,          KC_NO,          KC_NO,          KC_NO,          QK_BOOT,
    KC_NO,          KC_NO,          LGUI(KC_TAB),   LCTL(KC_UP),    LGUI(LCTL(LSFT(KC_4))),KC_NO,                                                                          DM_REC1,        KC_MS_BTN1,     KC_MS_UP,       KC_MS_BTN2,     KC_NO,          KC_NO,
    KC_NO,          KC_NO,          KC_MS_ACCEL0,   KC_MS_ACCEL1,   KC_MS_ACCEL2,   KC_NO,          KC_TRANSPARENT,                                 KC_TRANSPARENT, DM_REC2,        KC_MS_LEFT,     KC_MS_DOWN,     KC_MS_RIGHT,    KC_NO,          KC_NO,
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
    ...
    if (record->event.pressed) {
      SEND_STRING(SS_LSFT(SS_TAP(X_HOME)) SS_DELAY(40) SS_TAP(X_BSPACE));
    }
    break;
    case ST_MACRO_1:
    if (record->event.pressed) {
      SEND_STRING(SS_LSFT(SS_TAP(X_END)) SS_DELAY(40) SS_TAP(X_DELETE));
    }
    break;
    case ST_MACRO_2:
    if (record->event.pressed) {
...
bool get_retro_tapping(uint16_t keycode, keyrecord_t *record) {
    switch (keycode) {
        case LT(1,KC_SPACE):
        case LT(5,KC_SPACE):
        case LT(3,KC_LANGUAGE_2):
        case LT(7,KC_LANGUAGE_2):
        case LT(8,KC_LANGUAGE_1):
            return true;
        default:
            return false;
    }
